...
from djangocms_internalsearch.internal_search import PageContentConfig, TextContentConfig
...
class CoreCMSAppConfig(CMSAppConfig):
    ...
    internalsearch_config_list = [PageContentConfig, TextContentConfig, ]
