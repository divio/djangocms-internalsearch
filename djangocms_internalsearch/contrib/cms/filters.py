...
class ContentTypeFilter(admin.SimpleListFilter):
    ...
    def lookups(self, request, model_admin):
        ...
        models = [
            app.model.__name__ for app in internalsearch_config.cms_extension.internalsearch_apps_config
        ]
        return ((item, item) for item in models)
    ...
    def queryset(self, request, queryset):
        ...
        if self.value() is not None:
            return queryset.models(eval(self.value()))
