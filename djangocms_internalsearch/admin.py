...
class InternalSearchChangeList(SearchChangeList):
    def get_results(self, request):
        ...
        try:
            ...
            # expecting.
            result_list = [
                InternalSearchChangeList._make_model(result) for result in result_list
            ]
        except InvalidPage:
            result_list = ()
...
class InternalSearchModelAdminMixin(SearchModelAdminMixin):
    ...
    def get_queryset(self, request):
        ...
        if model_meta:
            ...
            qs = (
                InternalSearchQuerySet(self.haystack_connection)
                .models(model_klass)
                .all()
            )
    ...
    def action_checkbox(self, obj):
        ...
        return helpers.checkbox.render(
            helpers.ACTION_CHECKBOX_NAME, str(obj.haystack_id)
        )
...
class InternalSearchAdmin(
    InternalSearchAdminSetting, InternalSearchModelAdminMixin, ModelAdmin
):
